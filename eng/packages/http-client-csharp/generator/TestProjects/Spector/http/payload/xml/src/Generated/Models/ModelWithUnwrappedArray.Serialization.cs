...
namespace Payload.Xml
{
    ...
    public partial class ModelWithUnwrappedArray : IXmlSerializable, IPersistableModel<ModelWithUnwrappedArray>
    {
        ...
        public static implicit operator RequestContent(ModelWithUnwrappedArray modelWithUnwrappedArray)
        {
            if (modelWithUnwrappedArray == null)
            {
                return null;
            }
            return RequestContent.Create(modelWithUnwrappedArray, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="ModelWithUnwrappedArray"/> from. </param>
        public static explicit operator ModelWithUnwrappedArray(Response response)
        {

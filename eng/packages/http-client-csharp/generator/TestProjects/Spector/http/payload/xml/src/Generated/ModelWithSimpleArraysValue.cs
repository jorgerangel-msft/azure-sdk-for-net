...
namespace Payload.Xml
{
    ...
    public partial class ModelWithSimpleArraysValue
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ModelWithSimpleArraysValue.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<ModelWithSimpleArrays> Get(CancellationToken cancellationToken = default)
        {
            Response result = Get(cancellationToken.ToRequestContext());
            return Response.FromValue((ModelWithSimpleArrays)result, result);
        }

        /// <summary> Get. </summary>
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<ModelWithSimpleArrays>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ModelWithSimpleArraysValue.Put");
            scope.Start();
            try
            {
